...
class ClasspathExtensionProviderTest {
    ...
    private ClasspathExtensionProvider createObjectUnderTest() {
        return new ClasspathExtensionProvider(reflections);
    }


    @Test
    void loadExtensionPluginClasses_should_scan_for_plugins() {
        final ClasspathExtensionProvider objectUnderTest = createObjectUnderTest();

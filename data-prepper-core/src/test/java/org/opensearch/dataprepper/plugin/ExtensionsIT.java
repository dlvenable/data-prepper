...
import org.opensearch.dataprepper.plugins.TestExtension;
...
public class ExtensionsIT {
    ...
    private ExtensionsApplier createObjectUnderTest() {
        ...
        return coreContext.getBean(ExtensionsApplier.class);
    }
    ...
    void creating_a_plugin_using_an_extension() {
        ...
        TestPluginUsingExtension testPluginUsingExtension = (TestPluginUsingExtension) pluggableInterface;
    ...
    void creating_multiple_plugins_using_an_extension() {
        ...
        List<TestExtension.TestModel> models = new ArrayList<>();
        for (int i = 0; i < 5; i++) {
            final TestPluggableInterface pluggableInterface = pluginFactory.loadPlugin(TestPluggableInterface.class, pluginSetting);
        ...
        assertThat(models.get(0), not(sameInstance(models.get(1))));
        assertThat(models.get(1), not(sameInstance(models.get(2))));
        assertThat(models.get(2), not(sameInstance(models.get(3))));
        assertThat(models.get(3), not(sameInstance(models.get(4))));

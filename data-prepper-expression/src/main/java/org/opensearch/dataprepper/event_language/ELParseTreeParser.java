 ...
 */
@Named(ELParseTreeParser.SINGLE_THREAD_PARSER_NAME)
@Scope(ConfigurableBeanFactory.SCOPE_PROTOTYPE)
class ELParseTreeParser implements ELParser<ParseTree> {
    static final String SINGLE_THREAD_PARSER_NAME = "singleThreadELParser";
    ...
    private final DataPrepperEventLanguageParser parser;

    @Inject
    public ELParseTreeParser(final DataPrepperEventLanguageParser parser) {
        this.parser = parser;
     ...
     * before {@link DataPrepperEventLanguageParser#expression()} to prevent duplicate errors from being reported.
     *

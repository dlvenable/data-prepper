...
class ModelProcessor_AutoTypeTest {
    ...
    void testIteration1() throws IOException {
        setModelConfigToTarget("vpc-flow-log-auto.yaml");
        ...
        assertThat(firstRecord.getData().get("account-id", String.class), equalTo("123456789012"));
        assertThat(firstRecord.getData().get("interface-id", String.class), nullValue());
    ...
    void testIteration2_with_non_null() throws IOException {
        ...
        assertThat(firstRecord.getData().get("version", Integer.class), equalTo(2));
        assertThat(firstRecord.getData().get("account-id", String.class), equalTo("123456789012"));
        assertThat(firstRecord.getData().get("interface-id", String.class), equalTo("eni-abc12345"));
        assertThat(firstRecord.getData().get("srcport", Integer.class), equalTo(20987));
        assertThat(firstRecord.getData().get("dstport", Integer.class), equalTo(443));
    }
